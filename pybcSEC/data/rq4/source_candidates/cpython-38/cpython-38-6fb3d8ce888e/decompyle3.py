...
# [Clang 18.1.8 ]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_zipfile_AbstractWriterTests_test_close_after_close.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
mkfunc ::= expr . expr load_closure LOAD_CODE LOAD_STR MAKE_FUNCTION_78
mkfunc ::= expr expr . load_closure LOAD_CODE LOAD_STR MAKE_FUNCTION_78
...
-> 
 L.   5         0  LOAD_CODE                <code_object __pybcsec_seed__>
                   ...
                   4  MAKE_FUNCTION_78         'keyword-only, annotation, closure'
                   6  JUMP_IF_FALSE_OR_POP   110  'to 110'
