...
# [Clang 18.1.8 ]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_tarfile_MemberReadTest_test_find_regtype.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
-> 
 L.   5         0  LOAD_CODE                <code_object __pybcsec_seed__>
                   ...
                   6  SETUP_FINALLY         8  'to 8'
                 8_0  COME_FROM_FINALLY     6  '6'
