...
# [Clang 18.1.8 ]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_pydoc_PydocDocTest_test_not_here.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
L. 13:   8     return_expr ::= expr (5)
L. 13:   8-10  expr_jifop_cfs ::= expr JUMP_IF_FALSE_OR_POP \e__come_froms (6)
L. 13:   8-10  expr_jifop ::= expr JUMP_IF_FALSE_OR_POP (6)
