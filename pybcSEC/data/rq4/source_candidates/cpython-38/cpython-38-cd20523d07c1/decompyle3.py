...
# [Clang 18.1.8 ]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_call_CFunctionCallsErrorMessages_test_varargs3.py
...
Instruction context:
-> 
 L.   5         0  LOAD_ATTR                __pybcsec_seed__
