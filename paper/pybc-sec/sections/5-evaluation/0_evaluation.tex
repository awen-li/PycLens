...
This section reports the study results by research question.  The current draft keeps result tables as placeholders until the final measurements are inserted, but the reporting structure is fixed to match the four goals in Section~\ref{sec:study} and the methodology in Section~\ref{sec:method}.
