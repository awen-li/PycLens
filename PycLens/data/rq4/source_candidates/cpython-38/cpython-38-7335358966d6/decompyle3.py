...
# Python bytecode version base 3.8.0 (3412)
# Decompiled from: Python 3.8.20 (default, Sep  7 2024, 18:35:08) 
# [GCC 11.4.0]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test__xxsubinterpreters_RunStringTests_test_create_thread.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
L. 14:   8     c_stmts ::= _stmts (11)
        ...
        22     come_froms ::= COME_FROM (12)
L. 14:   8-22  ifstmt ::= testexpr stmts _come_froms (12)
