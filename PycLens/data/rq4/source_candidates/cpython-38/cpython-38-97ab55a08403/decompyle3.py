...
# [Clang 18.1.8 ]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_copy_TestCopy_test_copy_tuple_subclass.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
-> 
 L.   5         0  LOAD_CODE                <code_object __pybcsec_seed__>
                   ...
                   6  CALL_FUNCTION_EX_KW   247  'keyword and positional arguments'
