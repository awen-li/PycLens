...
# [GCC 11.4.0]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_source_encoding_MiscSourceEncodingTest_test_issue2301.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
L.  9:  16     expr ::= LOAD_GLOBAL (9)
L.  9:  16     return_expr ::= expr (9)
        18     expr ::= LOAD_CONST (10)
        20     expr ::= LOAD_STR (11)
        22     expr ::= LOAD_STR (12)
L.  9:  16-24  call ::= expr expr expr expr CALL_FUNCTION_3 (13)
L.  9:  16     expr ::= call (13)
L.  9:  16     return_expr ::= expr (13)
L.  9:  16-26  expr_stmt ::= expr POP_TOP (14)
L.  9:  16     stmt ::= expr_stmt (14)
...
L.  9:  16     suite_stmts ::= _stmts (14)
L.  9:  16     c_stmts ::= _stmts (14)
L.  9:  16     c_suite_stmts ::= c_stmts (14)
L.  9:  16     suite_stmts_opt ::= suite_stmts (14)
L.  9:  16     c_suite_stmts ::= suite_stmts (14)
L.  9:  16     c_suite_stmts_opt ::= c_suite_stmts (14)
L.  9:  16     c_suite_stmts_opt ::= suite_stmts_opt (14)
