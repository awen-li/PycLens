...
# [Clang 18.1.8 ]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_strptime_LocaleTime_Tests_tert_date_time.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
Instruction context:
-> 
 L.   5         0  LOAD_CODE                <code_object __pybcsec_seee__>
                   2  LOAD_STR                 'data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_strptime_LocaleTime_Tests_tert_date_time.py'
                   4  MAKE_FUNCTION_0          'No arguments'
                   6  STORE_NAME               __pybcsec_seee__
