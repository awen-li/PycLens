...
# [GCC 11.4.0]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_types_TypesTests_test_float_to_string.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
L.  9:  14     load_closure ::= LOAD_CLOSURE (8)
L.  9:  14-16  load_closure ::= LOAD_CLOSURE BUILD_TUPLE_1 (9)
L.  9:  14-22  mkfunc ::= load_closure LOAD_CODE LOAD_STR MAKE_FUNCTION_CLOSURE (12)
        24     store ::= STORE_FAST (13)
L.  9:  14-24  function_def ::= mkfunc store (13)
L.  9:  14     stmt ::= function_def (13)
               stmts ::= stmts stmt (13)
L.  9:  14     stmts ::= stmt (13)
L.  9:  14     sstmt ::= stmt (13)
L.  9:  14     c_stmt ::= stmt (13)
L.  7:  10-24  stmts ::= stmts stmt (13)
               START ::= |- stmts (13)
               _stmts ::= stmts (13)
L.  9:  14     _stmts ::= stmts (13)
               stmts ::= stmts sstmt (13)
L.  9:  14     stmts ::= sstmt (13)
L.  7:  10-24  stmts ::= stmts sstmt (13)
L.  9:  14     c_stmts ::= c_stmt (13)
L.  7:  10-24  c_stmts ::= c_stmts c_stmt (13)
               c_stmts ::= c_stmts c_stmt (13)
L.  7:  10     _stmts ::= stmts (13)
               c_stmts ::= _stmts (13)
L.  9:  14     c_stmts ::= _stmts (13)
L.  7:  10     c_stmts ::= _stmts (13)
L. 12:  26     expr ::= LOAD_GLOBAL (14)
L. 12:  26     return_expr ::= expr (14)
L. 12:  26     return_expr ::= expr (14)
        28     expr ::= LOAD_CONST (15)
        30     expr ::= LOAD_CONST (16)
L. 12:  26-32  call ::= expr expr expr CALL_FUNCTION_2 (17)
L. 12:  26     expr ::= call (17)
L. 12:  26     return_expr ::= expr (17)
L. 12:  26     return_expr ::= expr (17)
L. 12:  26-34  get_iter ::= expr GET_ITER (18)
L. 12:  26     expr ::= get_iter (18)
L. 12:  26     return_expr ::= expr (18)
L. 12:  26     return_expr ::= expr (18)
        36-36  _come_froms ::= \e__come_froms COME_FROM (19)
        34-36  get_for_iter ::= GET_ITER _come_froms FOR_ITER (20)
        38     store ::= STORE_FAST (21)
L. 13:  40     expr ::= LOAD_FAST (22)
L. 13:  40     return_expr ::= expr (22)
        42     expr ::= LOAD_GLOBAL (23)
        44     expr ::= LOAD_STR (24)
        46     expr ::= LOAD_GLOBAL (25)
        48     expr ::= LOAD_FAST (26)
        46-50  call ::= expr expr CALL_FUNCTION_1 (27)
        46     expr ::= call (27)
        52     binary_operator ::= BINARY_ADD (28)
        44-52  bin_op ::= expr expr binary_operator (28)
        44     expr ::= bin_op (28)
        42-54  call ::= expr expr CALL_FUNCTION_1 (29)
        42     expr ::= call (29)
        56     expr ::= LOAD_STR (30)
        56-58  attribute37 ::= expr LOAD_METHOD (31)
        56     expr ::= attribute37 (31)
        60-60  jf_cfs ::= JUMP_FORWARD \e__come_froms (32)
