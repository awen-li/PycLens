...
# [GCC 11.4.0]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_typing_CollectionsAbcTests_test_coroutine.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
L.  9:  18     return_expr ::= expr (10)
        ...
        22-24  call ::= expr CALL_FUNCTION_0 (13)
        22     expr ::= call (13)
        26     expr ::= LOAD_FAST (14)
L.  9:  18-28  call ::= expr expr expr expr CALL_FUNCTION_3 (15)
L.  9:  18     expr ::= call (15)
