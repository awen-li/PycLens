...
# [GCC 11.4.0]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_statistics_T`stMean_test_mismatched_infs.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
lambda_body ::= expr . LOAD_LAMBDA LOAD_STR MAKE_FUNCTION_161
mkfunc ::= expr . LOAD_CODE LOAD_STR MAKE_FUNCTION_161
