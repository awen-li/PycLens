...
# [Clang 18.1.8 ]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_xml_etree_ModuleTest_test_sanity.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
L.  8:  14     expr ::= LOAD_CONST (8)
L.  8:  14     expr ::= LOAD_CONST (8)
L.  8:  14     return_expr ::= expr (8)
L.  8:  14     return_expr ::= expr (8)
        16     expr ::= LOAD_CONST (9)
        18-20  import_from_attr37 ::= IMPORT_NAME_ATTR IMPORT_FROM (11)
        18-20  importattr37 ::= IMPORT_NAME_ATTR IMPORT_FROM (11)
        18     importlist37 ::= importattr37 (11)
        18     importlists ::= importlist37 (11)
        22     store ::= STORE_FAST (12)
        20-22  alias37 ::= IMPORT_FROM store (12)
        20     importlist37 ::= alias37 (12)
        20     importlists ::= importlist37 (12)
L.  8:  14-24  import_from_as37 ::= LOAD_CONST LOAD_CONST import_from_attr37 store POP_TOP (13)
L.  8:  14-24  import_as37 ::= LOAD_CONST LOAD_CONST importlist37 store POP_TOP (13)
L.  8:  14-24  import_from37 ::= LOAD_CONST LOAD_CONST IMPORT_NAME_ATTR importlist37 POP_TOP (13)
L.  8:  14     stmt ::= import_from_as37 (13)
L.  8:  14     stmt ::= import_as37 (13)
L.  8:  14     stmt ::= import_from37 (13)
               stmts ::= stmts stmt (13)
L.  8:  14     stmts ::= stmt (13)
L.  8:  14     sstmt ::= stmt (13)
L.  8:  14     c_stmt ::= stmt (13)
L.  7:  10-24  stmts ::= stmts stmt (13)
               START ::= |- stmts (13)
               _stmts ::= stmts (13)
L.  8:  14     _stmts ::= stmts (13)
               stmts ::= stmts sstmt (13)
L.  8:  14     stmts ::= sstmt (13)
L.  7:  10-24  stmts ::= stmts sstmt (13)
L.  8:  14     c_stmts ::= c_stmt (13)
L.  7:  10-24  c_stmts ::= c_stmts c_stmt (13)
               c_stmts ::= c_stmts c_stmt (13)
L.  7:  10     _stmts ::= stmts (13)
               c_stmts ::= _stmts (13)
L.  8:  14     c_stmts ::= _stmts (13)
L.  7:  10     c_stmts ::= _stmts (13)
L.  9:  26     expr ::= LOAD_CONST (14)
L.  9:  26     expr ::= LOAD_CONST (14)
L.  9:  26     return_expr ::= expr (14)
L.  9:  26     return_expr ::= expr (14)
