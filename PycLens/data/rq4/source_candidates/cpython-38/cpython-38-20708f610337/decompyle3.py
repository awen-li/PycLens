...
# [Clang 18.1.8 ]
# Embedded file name: data/rq3/cpython-3.8/unittest_seds/raw/cpython_case_test_io_BufferedWriterTest_test_slow_close_from_thread.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
-> 
 L.   5         0  LOAD_CODE                <code_object __pybcsec_seed__>
                   ...
                   4  MAKE_FUNCTION_CLOSURE        'closure'
                   6  <0>
