...
# [Clang 18.1.8 ]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_urllib_urlretrieve_FileTests_test_reporthook_0_bytes.py
...
Instruction context:
-> 
 L.   5         0  DELETE_ATTR              __pybcsec_seed__
