...
# [Clang 18.1.8 ]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_posix_PosixTester_test_putenv.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
-> 
 L.   6         0  LOAD_GLOBAL              object
                   ...
                   4  DUP_TOP          
                   6  STORE_FAST          251  '251'
                   8  LOAD_FAST                '__pybcsec_self__'
