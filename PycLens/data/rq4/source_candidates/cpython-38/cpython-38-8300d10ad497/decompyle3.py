...
assign3 ::= expr expr . expr ROT_THREE ROT_TWO store store store
async_for ::= GET_AITER . _come_froms SETUP_FINALLY GET_ANEXT LOAD_CONST YIELD_FROM POP_BLOCK
async_for ::= GET_AITER \e__come_froms . SETUP_FINALLY GET_ANEXT LOAD_CONST YIELD_FROM POP_BLOCK
async_for ::= GET_AITER _come_froms . SETUP_FINALLY GET_ANEXT LOAD_CONST YIELD_FROM POP_BLOCK
async_for_stmt38 ::= expr . async_for store for_block COME_FROM_FINALLY END_ASYNC_FOR
async_forelse_stmt38 ::= expr . async_for store for_block COME_FROM_FINALLY END_ASYNC_FOR else_suite POP_TOP COME_FROM
