...
# [GCC 11.4.0]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_descr_ClassPropertiesAndMethods_test_vicious_descriptor_nonsense.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
         ...
         6     store ::= STORE_NAME (4)
               ...
               c_stmts ::= c_stmt (4)
               c_stmts ::= _stmts (4)
L. 34:   8     expr ::= LOAD_NAME (5)
L. 34:   8     return_expr ::= expr (5)
L. 34:   8     return_expr ::= expr (5)
        10     expr ::= LOAD_STR (6)
L. 34:   8-12  compare_single ::= expr expr COMPARE_OP (7)
L. 34:   8     compare ::= compare_single (7)
L. 34:   8     expr ::= compare (7)
L. 34:   8     return_expr ::= expr (7)
L. 34:   8     return_expr ::= expr (7)
L. 34:   8-14  expr_pjif ::= expr POP_JUMP_IF_FALSE (8)
L. 34:   8-14  expr_pjif ::= expr POP_JUMP_IF_FALSE (8)
L. 34:   8     testfalse ::= expr_pjif (8)
L. 34:   8     and_parts ::= expr_pjif (8)
L. 34:   8     testfalse ::= expr_pjif (8)
L. 34:   8     and_parts ::= expr_pjif (8)
L. 34:   8     testexpr ::= testfalse (8)
L. 34:   8     testexprc ::= testexpr (8)
L. 34:   8     testexprc ::= testexpr (8)
L. 35:  16     expr ::= LOAD_NAME (9)
L. 35:  16     return_expr ::= expr (9)
L. 35:  16-18  call ::= expr CALL_FUNCTION_0 (10)
L. 35:  16     expr ::= call (10)
L. 35:  16     return_expr ::= expr (10)
L. 35:  16-20  expr_stmt ::= expr POP_TOP (11)
L. 35:  16     stmt ::= expr_stmt (11)
L. 35:  16     stmts ::= stmt (11)
L. 35:  16     sstmt ::= stmt (11)
L. 35:  16     c_stmt ::= stmt (11)
L. 34:   8-20  ifstmt ::= testexpr stmts \e__come_froms (11)
L. 34:   8-20  iflaststmt ::= testexpr stmts (11)
Reduce iflaststmt invalid by check
L. 35:  16     stmts_opt ::= stmts (11)
L. 35:  16     _stmts ::= stmts (11)
L. 35:  16     _stmts ::= stmts (11)
L. 35:  16     stmts ::= sstmt (11)
L. 35:  16     c_stmts ::= c_stmt (11)
L. 34:   8     stmt ::= ifstmt (11)
L. 35:  16     c_stmts ::= _stmts (11)
L. 35:  16     c_stmts ::= _stmts (11)
L. 34:   8-20  iflaststmtc ::= testexpr c_stmts (11)
Reduce iflaststmtc invalid by check
L. 35:  16     c_stmts_opt ::= c_stmts (11)
L. 35:  16     ifstmts_jumpc ::= c_stmts (11)
L. 34:   8-20  iflaststmtc ::= testexpr c_stmts (11)
Reduce iflaststmtc invalid by check
L. 35:  16     c_stmts_opt ::= c_stmts (11)
L. 34:   8-20  iflaststmtc ::= testexprc c_stmts (11)
Reduce iflaststmtc invalid by check
               stmts ::= stmts stmt (11)
L. 34:   8     stmts ::= stmt (11)
L. 34:   8     sstmt ::= stmt (11)
L. 34:   8     c_stmt ::= stmt (11)
L. 34:   8-20  ifstmtc ::= testexpr ifstmts_jumpc (11)
L. 34:   8-20  ifstmtc ::= testexprc ifstmts_jumpc \e__come_froms (11)
L. 34:   8-20  if_not_stmtc ::= testexprc ifstmts_jumpc \e__come_froms (11)
Reduce if_not_stmtc invalid by check
               START ::= |- stmts (11)
               _stmts ::= stmts (11)
L. 34:   8     _stmts ::= stmts (11)
               stmts ::= stmts sstmt (11)
L. 34:   8     stmts ::= sstmt (11)
L. 34:   8     c_stmts ::= c_stmt (11)
               c_stmts ::= c_stmts c_stmt (11)
L. 34:   8     c_stmt ::= ifstmtc (11)
               c_stmts ::= _stmts (11)
L. 34:   8     c_stmts ::= _stmts (11)
...
L. 34:   8-22  ifstmtc ::= testexprc ifstmts_jumpc _come_froms (12)
L. 34:   8-22  if_not_stmtc ::= testexprc ifstmts_jumpc _come_froms (12)
Reduce if_not_stmtc invalid by check
L. 35:  16-22  ifstmts_jump ::= stmts come_froms (12)
L. 35:  16-22  ifstmts_jump ::= stmts_opt come_froms (12)
L. 34:   8-22  whilestmt38 ::= \e__come_froms testexpr c_stmts come_froms (12)
Reduce whilestmt38 invalid by check
L. 34:   8-22  iflaststmtc ::= testexpr c_stmts come_froms (12)
Reduce iflaststmtc invalid by check
L. 34:   8-22  iflaststmtc ::= testexpr c_stmts come_froms (12)
Reduce iflaststmtc invalid by check
L. 35:  16-22  ifstmts_jumpc ::= c_stmts_opt come_froms (12)
L. 34:   8     stmt ::= ifstmt (12)
L. 34:   8     c_stmt ::= ifstmtc (12)
L. 34:   8-22  ifstmt ::= testexpr ifstmts_jump \e__come_froms (12)
L. 35:  16     ifstmts_jumpc ::= ifstmts_jump (12)
L. 34:   8-22  ifstmtc ::= testexpr ifstmts_jumpc (12)
L. 34:   8-22  ifstmtc ::= testexprc ifstmts_jumpc \e__come_froms (12)
L. 34:   8-22  if_not_stmtc ::= testexprc ifstmts_jumpc \e__come_froms (12)
Reduce if_not_stmtc invalid by check
               stmts ::= stmts stmt (12)
L. 34:   8     stmts ::= stmt (12)
L. 34:   8     sstmt ::= stmt (12)
L. 34:   8     c_stmt ::= stmt (12)
L. 34:   8     c_stmts ::= c_stmt (12)
               c_stmts ::= c_stmts c_stmt (12)
               START ::= |- stmts (12)
               _stmts ::= stmts (12)
L. 34:   8     _stmts ::= stmts (12)
               stmts ::= stmts sstmt (12)
L. 34:   8     stmts ::= sstmt (12)
               c_stmts ::= _stmts (12)
