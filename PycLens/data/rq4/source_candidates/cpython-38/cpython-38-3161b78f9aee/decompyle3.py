...
# [GCC 11.4.0]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_httplib_BasicTest_test_early_eof.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
L. 18:   8     c_stmts ::= _stmts (11)
        ...
        22     come_froms ::= COME_FROM (12)
L. 18:   8-22  ifstmt ::= testexpr stmts _come_froms (12)
