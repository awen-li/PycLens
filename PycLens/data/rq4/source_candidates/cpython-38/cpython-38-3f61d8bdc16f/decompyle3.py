...
# [GCC 11.4.0]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_subprocess_POSIXProcessTestCase_test_communicate_BrokenPipeError_stdin_write.py
               expr ::= LOAD_CODE (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
