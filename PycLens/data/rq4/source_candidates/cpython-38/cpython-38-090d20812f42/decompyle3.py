...
# [GCC 11.4.0]
# Embedded file name: data/rq3/cpython-3.8/unittest_seeds/raw/cpython_case_test_smtpd_SMTPDChannelTest_test_MAIL_empty_chevrons.py
               expr ::= LOAD_STR (1)
               return_expr ::= expr (1)
         2     expr ::= LOAD_STR (2)
...
Instruction context:
-> 
 L.   5         0  LOAD_STR                 '__pybcsec_seed__'
